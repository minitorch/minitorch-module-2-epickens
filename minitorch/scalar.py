...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        Args:
            d_output : The accumulated derivative from the output.

        Returns:
            Iterable[Tuple[Variable, Any]] : Pairs of (variable, derivative) for each parent.
        """
        h = self.history
        ...
        for i, x in enumerate(h.inputs):
            yield x, h.last_fn._backward(h.ctx, d_output)[i]
